...
export const APP_HISTORY_KEY = "__ircomNavState";
export const AUTH_SESSION_STORAGE_KEY = "__ircomAuthSession";
export const FEEDBACK_STORAGE_KEY = "__ircomFeedbackByItem";
...
export const PHOTO_PUBLIC_BASE_URL = String(import.meta.env.VITE_S3_PUBLIC_BASE_URL || "").trim().replace(/\/+$/, "");
export const normalizePhotoReference = (value) => {
...
export const normalizeRating = (value) => Math.max(1, Math.min(5, Number(value) || 1));
export const normalizePhotos = (photos, limit = 1) => {
...
export const getRestaurantDeliveryMode = (item) => {
...
export const getRestaurantDeliveryPrice = (item) => {
...
export const buildRestaurantId = (name) => {
...
export const profileValue = (value) => {
  const text = String(value || "").trim();
  return text === "-" ? "" : text;
};
export const buildInitialFeedback = () => {
...
export const getFeedbackRating = (reviews) => {
...
export const pickFirstNumber = (...values) => {
...
export const mapMenuItemToUi = (item) => ({
