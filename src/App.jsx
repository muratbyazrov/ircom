      ...
      <main className="screen">
        ...
        {tab === "services" && (
          <>
            ...
            <Section>
              <CategoryTabs list={mock.serviceCategories} value={serviceCategory} onChange={setServiceCategory} />
        ...
        {tab === "taxi" && (
          <>
            ...
            <Section>
              <CategoryTabs list={mock.taxiCategories} value={taxiCategory} onChange={setTaxiCategory} />
        ...
        {tab === "food" && (
          <>
            ...
            <Section>
              <CategoryTabs list={mock.foodCategories} value={foodCategory} onChange={setFoodCategory} />
...
function CategoryTabs({ list, value, onChange }) {
  return (
